...
<head>
    ...
    <title>Botez</title>
    <link rel="stylesheet" href="/css/botez.css">
      ...
      <div class="container">
        ...
        <div class="content">
            <div class="p-of-img">
                <p>Daca esti in cautarea unei locatii in care sa organizezi un pranz sau cina in urma unui Botez,
                    ...
                    <br>
                    <br>
                    Cadrul frumos al grădinii naturale pe acoperiș situat la etajul 2 devine spațiul ideal pentru a uimi
                    prietenii și rudele de la sfârșitul primăverii până la începutul toamnei.
        ...
        <div>
            <p class="offer">
                ...
                <br>
                Parcare privată <br>
                Parcarea privată este disponibilă pentru toți clienții restaurantului, în funcție de disponibilitate.
            </p>
        </div>
</main>
<?php 
